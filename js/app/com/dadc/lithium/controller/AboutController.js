include( "js/app/com/dadc/lithium/view/widgets/AboutWidget.js" );
var AboutController = function( ParentControllerObj ){
    ...
    var m_about_widget              = new AboutWidget();
    var m_is_focussed;
    ...
    this.getControllerName = function(){return 'AboutController';};
    this.open = function( ){
        m_root_node.addChild( m_master_container );
        AnalyticsManagerInstance.firePageViewEvent({cc0:'mycrackle', cc1:'about'})
    };
    this.close = function( ){
