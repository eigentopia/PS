...
//         typeof ns_p == "undefined" && (ns_p = {src: e})
    ...
    function comscoreObj (mediaDetails){
        ...
        var comObj =  {
            ...
            //ns_st_pn : "1", 
            ns_st_tp : (mediaDetails.Chapters)?mediaDetails.Chapters.length.toString():"1", // ... of 3 parts in total
    ...
    function startPlaylist(mediaObj){
        ...
        else if(mediaDetails.Chapters == null){
            var clip = new comscoreObj(mediaObj.m_data)
            clip.ns_st_pn = "1"
            clip.startTime = "0"
            clip.endTime = (parseInt(mediaDetails.DurationInSeconds)*1000).toString();
            clips.push(clip)
