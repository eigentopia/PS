...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
var HistoryRequest = function( callback ){
    //SAMPLE URL
    //http://api.crackle.com/Service.svc/featured/movies/all/us/30?format=json
    var url = ModelConfig.getServerURLRoot() + "history/list/member/272424/272424/US?format=json"
    Logger.log( url );
    var httpRequestObj;
    var http_retries;
    var api_retries;
...
var History = function( json_data ){
    this.m_data = json_data;

    //CREATING OBJECTS
    var statusObj           = new HistoryStatus( this.m_data.status );
    var itemListObj         = new HistoryItemList( this.m_data.Items );
...
var HistoryStatus = function( data ){
...
var HistoryItemList = function( data ){
