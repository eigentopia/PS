...
var HistoryWidget = function( ) {
    ...
    this.update = function( engine_timer ){
        if( LoggerConfig.CONFIG.UPDATE_DEBUG ) Logger.log( 'HistoryWidget update() ' + engine_timer );
...
var HistoryTile = function( DataObj, renderOnStart ) {
    ...
    this.update = function( engine_timer ){
        if( LoggerConfig.CONFIG.UPDATE_DEBUG ) Logger.log( 'HistoryTile update() ' + engine_timer );
        if( m_render_status == HistoryTile.RENDER_STATUS.RENDERING && m_loading_widget )
            m_loading_widget.update( engine_timer );
    };
    this.destroy = function(){
        Logger.log( 'HistoryTile destroy()' );
