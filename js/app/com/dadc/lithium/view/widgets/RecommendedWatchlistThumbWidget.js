/**
 */
var RecommendedWatchlistThumbWidget = function( ChannelDetailsObj ) {
    var m_root_node                         = engine.createContainer();
    var m_channel_details_obj               = ChannelDetailsObj;
    var m_image_container;
    var This = this;
    this.update = function( engine_timer ){
        if( LoggerConfig.CONFIG.UPDATE_DEBUG ) Logger.log( 'RecommendedWatchlistThumbWidget update() ' + engine_timer );
